...
function updateCardsInGame() {
    ...
    quarterAvePER = quaterPER / playersOnCourt;
    document.getElementById('currenrPER'.innerText = 'Current PER: '+ quarterAvePER.toPrecision(4));
...
function endQuarter() {
    ...
    document.geElementById('start').innerText = 'Start Q '+ (currentQuarter+1);
...
function endGame() {
    ...
    totalAePER += parseFloat(quarterAvePER);
